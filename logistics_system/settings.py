...
SECRET_KEY = 'django-insecure-(t5ie-1@0zn*jrca*4ox$nc991n0ffetjdjfc&yjgu0dqnw_v0'
...
TIME_ZONE = 'Africa/Lagos' # Based on user time
...
DEFAULT_FROM_EMAIL = f"Global Courier Logistics <{EMAIL_HOST_USER}>"
